...
const Navbar = ({ visible }) => {
    ...
    return (
        <AnimatePresence>
            ...
            >
                {/* Logo Pill */}
                <a href="#" className="flex items-center justify-center px-6 py-2.5 rounded-full bg-primary text-white font-bold tracking-tight text-sm hover:scale-105 transition-transform duration-300 shadow-md whitespace-nowrap">
